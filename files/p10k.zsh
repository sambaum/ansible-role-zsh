# Generated by Powerlevel10k configuration wizard on 2019-08-26 at 22:42 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 51787.
# Wizard options: nerdfont-complete + powerline, large icons, lean, 2 lines, dotted,
# compact, many icons, fluent.
...
() {
  ...
  POWERLEVEL9K_ALWAYS_SHOW_CONTEXT=true # Custom Sam
